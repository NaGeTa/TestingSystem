...
public class TestsControllerServiceTest {
    ...
    @Mock
    SolutionServiceTest solutionService;
    @Mock
    SendServiceTest sendService;
    @Mock
    TestServiceTest testService;
    @Mock
    QuestionServiceTest questionService;
    @Mock
    Logger logger = Logger.getLogger(TestsControllerServiceTest.class);
