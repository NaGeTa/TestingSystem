...
public class UserControllerServiceTest {
    ...
    private final SolutionServiceTest solutionService;
    private final TestServiceTest testService;
    private static final Logger logger = Logger.getLogger(UserControllerServiceTest.class);
